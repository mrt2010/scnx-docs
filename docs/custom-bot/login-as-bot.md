...
You can find a detailed description for all the features of the message editor in the [Message editor](#message-editor) section.
...
You can find out how to work with Custom Commands and how to create your own buttons in the [Custom Commands documentation](https://docs.scnx.xyz/docs/custom-bot/custom-commands/).
